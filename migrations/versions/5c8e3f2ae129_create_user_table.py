...
Revision ID: 5c8e3f2ae129
Revises: 
Create Date: 2026-08-05 11:00:29.318626
...
def upgrade() -> None:
    ...
    sa.Column('security_question', sa.Enum('MOTHER_MAIDEN_NAME', 'CHILDHOOD_FRIEND', 'FAVORITE_COLOR', 'BIRTH_CITY', name='securityquestionschema'), nullable=False),
    sa.Column('security_question_answer', sqlmodel.sql.sqltypes.AutoString(length=30), nullable=False),
