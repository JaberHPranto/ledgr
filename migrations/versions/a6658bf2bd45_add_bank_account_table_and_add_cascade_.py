"""add bank account table and add cascade delete on user relation

Revision ID: a6658bf2bd45
Revises: a0fafbfca3a4
Create Date: 2026-08-17 12:34:10.347628
...
revision: str = 'a6658bf2bd45'
down_revision: Union[str, None] = 'a0fafbfca3a4'
...
def upgrade() -> None:
    ...
    sa.Column('currency', sa.Enum('USD', 'EUR', 'GBP', name='accountcurrencyenum'), nullable=False),
